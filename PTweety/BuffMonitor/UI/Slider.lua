...
function Slider:Constructor()
    ...
    self.leftArrow:SetBackground("PTweety/BuffMonitor/UI/Resources/slider_leftarrow.tga");
    ...
    self.leftArrow.MouseEnter = function(sender, args)
        self.leftArrow:SetBackground("PTweety/BuffMonitor/UI/Resources/slider_leftarrow_highlight.tga");
    end
    ...
    self.leftArrow.MouseDown = function(sender, args)
        ...
        if (args.Button == Turbine.UI.MouseButton.Left) then
            ...
            self.leftArrow:SetBackground("PTweety/BuffMonitor/UI/Resources/slider_leftarrow_pressed.tga");
    ...
    self.rightArrow:SetBackground("PTweety/BuffMonitor/UI/Resources/slider_rightarrow.tga");
    ...
    self.rightArrow.MouseEnter = function(sender, args)
        self.rightArrow:SetBackground("PTweety/BuffMonitor/UI/Resources/slider_rightarrow_highlight.tga");
    end
    ...
    self.rightArrow.MouseDown = function(sender, args)
        ...
        if (args.Button == Turbine.UI.MouseButton.Left) then
            ...
            self.rightArrow:SetBackground("PTweety/BuffMonitor/UI/Resources/slider_rightarrow_pressed.tga");
    ...
    self.sliderBox:SetBackground("PTweety/BuffMonitor/UI/Resources/slider_background.tga");
    ...
    self.slider:SetBackground("PTweety/BuffMonitor/UI/Resources/slider_widget.tga");
...
function Slider:SetEnabled(enabled)
    ...
    if (enabled) then
        ...
        self.slider:SetBackground("PTweety/BuffMonitor/UI/Resources/slider_widget_ghosted.tga");
    end
end
...
function Slider:UpdateValueFromPosition()
    ...
    PTweety.BuffMonitor.Utils.ExecuteCallback(self, "ValueChanged", {value=self.value});
end
