...
function CheckBox:Constructor()
    ...
    self.check:SetBackground("PTweety/BuffMonitor/UI/Resources/checkbox_02_empty.tga");
...
function CheckBox:SetChecked(checked)
    ...
    self:UpdateState();
    PTweety.BuffMonitor.Utils.ExecuteCallback(self, "CheckedChanged", {checked=self:IsChecked()});
end
...
function CheckBox:UpdateState()
    ...
    if (self.checked) then
        self.check:SetBackground("PTweety/BuffMonitor/UI/Resources/checkbox_02"..(enabled and "" or "_ghosted")..".tga");
    else
        self.check:SetBackground("PTweety/BuffMonitor/UI/Resources/checkbox_02_empty"..(enabled and "" or "_ghosted")..".tga");
    end
end
