...
local restoreV420Traits = function()
  ...
  traits.buffs = (player.isCreep and {} or
  {
    ...
    {class = "Warden", skillName = L.Conviction, appliedBy = {L.Conviction}},
  ...
  if (player.class == "Burglar") then
    ...
    table.insert(traits.configurations[L.TheQuietKnife].debuffs, {ca = true, bb = true, class = "Burglar", skillName = L.Addle, iconName = "addle.tga", overwrites = {L.Addle}, appliedBy = {{skillName = L.Addle, duration = 30}, {skillName = L.ImprovedAddle, duration = 30}}});
    table.insert(traits.configurations[L.TheQuietKnife].debuffs, {ca = true, bb = true, class = "Burglar", skillName = L.TrickDisable, iconName = "disable.tga", overwrites = {L.TrickDisable,L.TrickCounterDefence,L.TrickDustInTheEyes,L.TrickEnrage}, appliedBy = {{skillName = L.TrickDisable, duration = 30}, {skillName = L.TrickImprovedDisable, duration = 30}}});
    ...
    table.insert(traits.configurations[L.TheMischiefMaker].debuffs, {ca = true, bb = true, class = "Burglar", skillName = L.Addle, iconName = "addle.tga", overwrites = {L.Addle}, appliedBy = {{skillName = L.Addle, duration = 30}, {skillName = L.ImprovedAddle, duration = 30}}});
    table.insert(traits.configurations[L.TheMischiefMaker].debuffs, {ca = true, bb = true, class = "Burglar", skillName = L.TrickDisable, iconName = "disable.tga", overwrites = {L.TrickDisable,L.TrickCounterDefence,L.TrickDustInTheEyes,L.TrickEnrage}, buffEffects = {{skillName = L.Mischievous, duration = 10}}, appliedBy = {{skillName = L.TrickDisable, duration = 30}, {skillName = L.TrickImprovedDisable, duration = 30}}});
    ...
    table.insert(traits.configurations[L.TheGambler].debuffs, {ca = true, bb = true, class = "Burglar", skillName = L.Addle, iconName = "addle.tga", overwrites = {L.Addle}, appliedBy = {{skillName = L.Addle, duration = 30}, {skillName = L.ImprovedAddle, duration = 30}}});
    table.insert(traits.configurations[L.TheGambler].debuffs, {ca = true, bb = true, class = "Burglar", skillName = L.TrickDisable, iconName = "disable.tga", overwrites = {L.TrickDisable,L.TrickCounterDefence,L.TrickDustInTheEyes,L.TrickEnrage}, appliedBy = {{skillName = L.TrickDisable, duration = 30}, {skillName = L.TrickImprovedDisable, duration = 30}}});
