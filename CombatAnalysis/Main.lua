...
-- Gustavo 16.02.2013 21:46:40: fix
L = {}
...
Turbine.Shell.WriteLine("Combat Analysis v"..versionNo.." by Evendale"..(locale ~= "en" and L.TranslatedBy ~= nil and L.TranslatedBy ~= "" and " ("..L.TranslatedBy..")" or ""));
