...
function CombatAnalysisBar:Layout()
	...
	self.value1:SetLeft(w-CombatAnalysisWindow.border-CombatAnalysisBarsPanel.valueTextLength);
	self.value2:SetLeft(w-2*CombatAnalysisWindow.border-2*CombatAnalysisBarsPanel.valueTextLength);
