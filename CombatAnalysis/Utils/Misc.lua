...
function _G.DiscardArgs(args)
  ...
  if (string.len(hackText) >= 1 and string.sub(hackText,string.len(hackText)) == "\n") then hackText = string.sub(hackText,1,string.len(hackText)-1) end
