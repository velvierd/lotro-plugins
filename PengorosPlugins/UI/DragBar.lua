...
function DragBar:Constructor(target, name)
    ...
    self.grabber.MouseDown = function(sender, args)
        if (args.Button == Turbine.UI.MouseButton.Left) then
            self.gem:SetBackground(dragBarGemPressed);
            self.label:SetBackground(dragBarPressed);
            self.dragStartX = args.X;
            self.dragStartY = args.Y;
            self.dragging = true;
            PengorosPlugins.Utils.ExecuteListener(self.target, "DragStart", {});
        end
    end
    ...
    self.grabber.MouseUp = function(sender, args)
        if (args.Button == Turbine.UI.MouseButton.Left) then
            self.gem:SetBackground(dragBarGem);
            self.label:SetBackground(dragBar);
            self.dragging = false;
            PengorosPlugins.Utils.ExecuteListener(self.target, "DragEnd", {});
        end
    end
    ...
    self.topLeft:SetBackground(dragBarTopLeft);
    ...
    self.topRight:SetBackground(dragBarTopRight);
    ...
    self.bottomLeft:SetBackground(dragBarBottomLeft);
    ...
    self.bottomRight:SetBackground(dragBarBottomRight);
    ...
    self.top:SetBackground(dragBarMidTop);
    ...
    self.left:SetBackground(dragBarMidLeft);
    ...
    self.right:SetBackground(dragBarMidRight);
    ...
    self.bottom:SetBackground(dragBarMidBottom);
