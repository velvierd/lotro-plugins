...
L["Champion Skill Bubble Magnitude"] = "к радиусу умений воителя с действией на область (на самом деле - к силе баблов воителя!!!)"; -- ололо локализаторы! ;) "к восстановлению боевого духа умениями воителя"
...
L["Guardian Bleed Pulses"] = "к длительности эффекта кровотечения, вызванного умениями стража"; --
