...
function TravelDictionaries:CreateDictionaries()
   ...
   if(Turbine.UI.Control.IsDisplayed ~= nil) then
	  ...
	  genLocations:AddData("Возвращение к путевому камню 7","0x7002FF5E","skip");
	  genLocations:AddData("Возвращение к путевому камню 8","0x7002FF5F","skip");
	  genLocations:AddData("Возвращение к путевому камню 9","0x7002FF60","skip");
	  genLocations:AddData("Возвращение к путевому камню 10","0x7002FF61","skip");
	  genLocations:AddData("Возвращение к путевому камню 11","0x7002FF62","skip");
	  genLocations:AddData("Возвращение к путевому камню 12","0x7002FF63","skip");
	end
